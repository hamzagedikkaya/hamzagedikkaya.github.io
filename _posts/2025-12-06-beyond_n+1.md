...
**Update (May 2026):** I ended up building a static analyzer to catch most of the patterns in this post automatically — in CI, without running tests, hitting a DB, or booting Rails. See [EagerEye: Catching the N+1s Bullet Misses — with Static Analysis]({% post_url 2026-05-03-eager_eye_static_analysis %}) for the design decisions and real-world numbers from running it on production codebases.
